...
const UploadUpateForm = () => {
    ...
    const onUploadSubmit = (e) => {
        ...
        */}
        ...
        axios.post(`http://localhost:8080/user/uploadUpdate?seq=${seq}`, formData, {
            headers : {
                ...
                <table border="1">
                    ...
                    <tr>
                        <td colSpan="2">
                            <span id="showImgList">
                                {
                                    <img src={`https://kr.object.ncloudstorage.com/bitcamp-6th-bucket-97/storage/${userUploadDTO.imageFileName}`} width="70" height="70"/>
                                }
                            </span>
                            <img src={camera} id="camera" alt="카메라" width="50" height="50" onClick={onCamera} />
                    ...
                    <tr>
                        <td colSpan="2" align="center">
                            ...
                            <input type="submit" onClick={onUploadSubmit} value="수정" id="uploadUpdateBtn"/>
...
export default UploadUpateForm;